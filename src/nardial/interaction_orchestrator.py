...
class InteractionConfig:
    ...
    def __init__(self, language="en", tts_conf: TTSConf = None, microphone_device=None, google_keyfile_path=None,
                 openai_key_path=None, sleep_time=None, signal_listening_behavior=True):
...
class InteractionOrchestrator:
    ...
    @InteractionConfig.apply_config_defaults('interaction_conf', ['sleep_time', 'animated', 'always_regenerate', 'chunk_audio'])
