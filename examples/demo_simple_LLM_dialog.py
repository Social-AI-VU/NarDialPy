...
This demo shows a minimal LLM-based conversation flow without RAG.

The conversation flow is defined in:
    dialog_json/simple_llm_dialogs.json
...
DIALOG_CONFIG_PATH = BASE_DIR / "dialog_json" / "simple_llm_dialogs.json"
